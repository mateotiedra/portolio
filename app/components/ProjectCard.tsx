...
const blobs = [
  ...
  (color: string) => <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill={color} d="M62.5,-50.9C77.7,-30.7,84.6,-4.9,79,17.4C73.4,39.7,55.3,58.5,35.6,64.3C15.8,70.1,-5.5,63,-18.6,51.7C-31.7,40.4,-36.5,24.9,-37,11.6C-37.5,-1.7,-33.7,-12.8,-26.9,-31C-20,-49.3,-10,-74.6,6.8,-80.1C23.6,-85.5,47.3,-71,62.5,-50.9Z" transform="translate(100 100)" /></svg>,
