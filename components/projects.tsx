...
import { AccountingChip, ConceptionChip, FlutterChip, GoogleAdminChip, GoogleCloudChip, Love2DChip, LuaChip, MuiChip, NodejsChip, NumpyChip, PlanningChip, PythonChip, PyTorchChip, ReactChip, ReactNativeChip, StaffChip, TailwindChip } from './TechChip';
...
export const projectsFr: ProjectProps[] = [
    {
        ...
        title: 'Super S8000',
        id: 'lummx2221',
        lilTags: { 'Temps de travail': '8 semaines', 'Budget': 'CHF270', 'Moteurs': '6', 'Équipe': 'de 6' },
        techTags: [<PythonChip key="py" />, <PyTorchChip key="pt" />, <NumpyChip key="np" />],
        preview: ['videos/ss8.mp4'],
        color: '#01a63e',
        description: <p>Le <a href='https://github.com/epfl-cs358/2024fa-superscanner8000' target='_blank' rel="noreferrer">SuperScanner8000</a> est un robot qui scanne en 3D un object selectionné. Il se déplace afin de prendre des photos sous différents angles, qu{"'"}il utilise dans <a href='https://repo-sam.inria.fr/fungraph/3d-gaussian-splatting/' target='_blank' rel="noreferrer">3DGS</a> pour la recontruction du modèle en 3D. La détection de l{"'"}objet se fait via <a href="https://github.com/Gy920/segment-anything-2-real-time" target="_blank" rel="noreferrer">une variante de Segment Anything 2</a>.</p>,
        status: 'Terminé',
        since: 'décembre 2024',
    ...
    },
    {
        ...
        lilTags: { 'Date': '05.10.24', 'Participants': '2400', 'Staffs': '180', 'Bars': '4', 'Scènes': '2' },
        techTags: [<StaffChip key="s" />, <PlanningChip key="p" />],
        preview: ['videos/ndlm24.mp4'],
        color: '#c3a36a',
        description: <p>La <a href='https://nuit-de-la-magistrale.ch/' target='_blank' rel="noreferrer">Nuit de La Magistrale</a> est l{"'"}événement officiel concluant la remise des diplômes de master de <a href='https://www.epfl.ch/' target='_blank' rel="noreferrer">l{"'"}EPFL</a>. Organiser un évenement de cette ampleur au <a href='https://www.stcc.ch/' target='_blank' rel="noreferrer">Swisstech Convention Center</a> est un défi technique et logistique de taille. En tant que responsable des opérations, j{"'"}étais en charge de coordonner le montage/démontage du site ainsi que de recruter et gérer les 180 bénévoles.</p>,
    ...
    },
    {
        ...
        lilTags: { 'Date': '28.09.24', 'DJ': '6', 'Participants': '500', 'Staffs': '20', 'Bière': 'CHF3' },
        techTags: [<StaffChip key="s" />, <AccountingChip key="a" />],
        preview: ['videos/lummx2221.mp4'],
        color: 'silver',
        description: <p>Quatrième édition de la <a href='https://www.lumm.love/' target='_blank' rel="noreferrer">LÜMM</a> organisée en collaboration étroite avec <a href='https://2221.ch/' target='_blank' rel="noreferrer">2221.ch</a>. Première édition où nous sortons nos nouveaux panneaux leds, visuels et VJing par <a href='https://www.instagram.com/stories/b0nk_13' target='_blank' rel="noreferrer">b0nk</a>.<br />Soutenue par la brasserie <a href='https://lanebuleuse.ch/' target='_blank' rel="noreferrer">La Nébuleuse</a> et <a href='https://www.eltonymate.com/' target='_blank' rel="noreferrer">El Tony Mate</a>.</p>,
        status: 'Gros banger',
    ...
    },
    {
        ...
        lilTags: { 'Events': '4', 'Festivalier.x.s': '1200', 'Membres du comité': '29' },
        techTags: [<ReactChip key="r" />, <TailwindChip key="t" />, <GoogleAdminChip key="g" />],
        link: 'https://artiphys.ch/',
        preview: ['videos/artiphys.mp4'],
        color: '#f9a5ee',
        description: <p>Membre du comité de l{"'"}association <a href='https://www.artiphys.ch/' target='_blank' rel="noreferrer">Artiphys</a> pour cette éditon 2025. Refonte du site web pour le faire correspondre à la nouvelle direction artistique et au nouveau comité. Gestion des entrées et des billeteries de chaque évenements.</p>,
        status: 'Membre du comité',
    ...
    },
    {
        ...
        lilTags: { 'Utilisateurs': '650', 'Livres vendus': '300', 'Livres en vente': '6000' },
        techTags: [<ReactChip key="r" />, <NodejsChip key="n" />, <MuiChip key="m" />],
        link: 'https://www.okalo.ch/',
        preview: ['videos/okalo.mp4'],
        color: '#0496FF',
        description: <p>Utilisé dans plus d{"'"}une dizaine de collèges genevois, <a href='https://www.okalo.ch/' target='_blank' rel="noreferrer">Okalo</a> facilite l{"'"}achat et la vente de livres d{"'"}occasion pour les étudiants, leur permettant ainsi de faire des économies et de donner une seconde vie à leurs bouquins inutilisés.</p>,
        status: 'Actif',
    ...
    },
    {
        ...
        lilTags: { 'Date': '11.05.24', 'Participants': '700', 'Staffs': '46', 'Bière': 'CHF2' },
        link: 'https://www.lumm.love/',
        preview: ['videos/lummc.mp4'],
        color: 'rgb(205, 24, 27)',
        techTags: [<StaffChip key="s" />, <PlanningChip key="p" />, <AccountingChip key="a" />],
        description: <p>Troisième édition de la <a href='https://www.lumm.love/' target='_blank' rel="noreferrer">LÜMM</a>, une association que nous avons officielement fondée début 2024 avec Kake, Loulou, Noa, Hamousz, Kerem &amp; Tonio.<br />Avec la participation du bar <a href='https://satellite.bar/' target='_blank' rel="noreferrer">Satellite</a> et <a href='https://artepoly.agepoly.ch/' target='_blank' rel="noreferrer">ArtePoly</a> de l{"'"}EPFL. Soutenue par la brasserie <a href='https://lanebuleuse.ch/' target='_blank' rel="noreferrer">La Nébuleuse</a> et <a href='https://www.eltonymate.com/' target='_blank' rel="noreferrer">El Tony Mate</a></p>,
        status: 'Big succès',
        instaUrl: 'https://www.instagram.com/lumm.love/',
        categories: ['assoc']
    },
    {
        ...
        color: 'white',
        techTags: [<GoogleCloudChip key="gc" />, <ReactChip key="r" />, <NodejsChip key="n" />],
        description: <p>Le but principal de ce projet était de remplacer les fameux <span style={{ fontStyle: 'italic' }}>&quot;Envoyez vos photos sur le groupe.&quot;</span><br /><a href='https://morii.lumm.love/' target='_blank' rel="noreferrer">Morii</a> est une plateforme de partage de photos qui permet de se souvenir des bons moments grâce à des photos triées et sans perte de qualité.</p>,
        status: 'En pause',
        since: 'mai 2024',
        categories: ['dev']
    },
...
export const projectsEn: ProjectProps[] = [
    ...
    },
    {
        ...
        techTags: [<ConceptionChip key="c" />, <PythonChip key="py" />, <PyTorchChip key="pt" />, <NumpyChip key="np" />],
        preview: ['videos/ss8.mp4'],
        color: '#01a63e',
