...
function ProjectCard({
    ...
    return <div className='relative overflow-visible'>
        <div className='max-w-[600px] h-full flex flex-col justify-between z-20'>
        ...
        <div className='absolute w-[150%] h-[150%] top-1/3 left-1/3 -translate-x-1/2 -translate-y-1/2 -z-20 opacity-15'>
            {blob}
        </div>
    </div>
}
